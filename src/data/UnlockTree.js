...
export const UNLOCK_NODES = {
  ...
  meta_salvage_1: {
    ...
    name: '잔해 회수 I', desc: '사망 시 메타 보존율 +5% (20 → 25%)',
    apply: (p) => { p.metaRetainRate = (p.metaRetainRate ?? 0.2) + 0.05; },
  },
  core_collector: {
  ...
  meta_salvage_2: {
    ...
    name: '잔해 회수 II', desc: '사망 시 메타 보존율 +5% (→ 30%)',
    apply: (p) => { p.metaRetainRate = (p.metaRetainRate ?? 0.2) + 0.05; },
  },
  memory_frag: {
  ...
  meta_salvage_3: {
    ...
    name: '잔해 회수 III', desc: '사망 시 메타 보존율 +5% (→ 35%)',
    apply: (p) => { p.metaRetainRate = (p.metaRetainRate ?? 0.2) + 0.05; },
  },
  merchant_credit: {
  ...
  meta_salvage_4: {
    ...
    name: '잔해 회수 IV', desc: '사망 시 메타 보존율 +5% (→ 40%)',
    apply: (p) => { p.metaRetainRate = (p.metaRetainRate ?? 0.2) + 0.05; },
  },
  bargain_2: {
