...
├── characters/             soma-sprite-sheet8.png (8방향 4×2 그리드, BootScene 에서 프레임 분할)
...
- 스프라이트: `public/assets/characters/soma-sprite-sheet8.png` (8방향 4×2 그리드 — BootScene `_processPlayerSprites()` 에서 방향별 프레임으로 분할, 각 칸 내용물 경계에 맞춰 타이트 크롭)
- 표시: `PLAYER_SCALE=0.18` 공통 스케일(표시 높이 ~45px, 방향별 원본 비율 유지) / Hitbox: `BODY_W=40, BODY_H=38`
